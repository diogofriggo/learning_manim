...
class PythagorasTheorem(Scene):
    ...
    def construct2(self):
        left_square, right_square =  Square(color=YELLOW), Square(color=YELLOW)
        VGroup(left_square,right_square).scale(self.square_scale).arrange_submobjects(RIGHT,buff=2)
        ...
        # FORMULAS
        theorem = TexMobject("a^2","=","b^2","+","c^2",color=BLUE).to_edge(DOWN)
